...
static void BuzzerSound(void)
{
    ...
    {
        DIO_WritePort(BuzzerConfig.Portname,BUZEER_ON,BuzzerConfig.PortMaskk);
        _delay_ms(25u);
        DIO_WritePort(BuzzerConfig.Portname,(u8)~BUZEER_ON,BuzzerConfig.PortMaskk);
        _delay_ms(25u);
...
static void PowerBluetoothOn(void)
{
    DIO_WritePort(BlueToothPwrConfig.Portname,BLOUETOOTH_ON,BlueToothPwrConfig.PortMaskk);
}
/*********************************************************************************/
static void PowerBluetoothOff(void)
{
...
static void BuzzerInit(void)
{
    DIO_InitPortDirection(BuzzerConfig.Portname,0xffu,BuzzerConfig.PortMaskk);
    DIO_WritePort(BuzzerConfig.Portname,0x00u,BuzzerConfig.PortMaskk);
}
/*********************************************************************************/
static void PowerBlueToothInit(void)
{
    DIO_InitPortDirection(BlueToothPwrConfig.Portname,0xffu,BlueToothPwrConfig.PortMaskk);
    DIO_WritePort(BlueToothPwrConfig.Portname,0x00u,BlueToothPwrConfig.PortMaskk);
}
/*********************************************************************************/
static void BlueToothKeyInit(void)
{
    DIO_InitPortDirection(BluetoothKeyConfig.Portname,0xffu,BluetoothKeyConfig.PortMaskk);
    DIO_WritePort(BluetoothKeyConfig.Portname,0xffu,BluetoothKeyConfig.PortMaskk);
}

static void InserBreakPoint(void)
{
    DIO_WritePort(BuzzerConfig.Portname,0xffu,BuzzerConfig.PortMaskk);
    while(1)
    {
